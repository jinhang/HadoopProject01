...
public class TableLine 
{
	...
	public void set ( String line, boolean source, String date, String [] timepoint ) throws LineException
	{
		...
		//�?��日期合法�?		if ( ! this.time.startsWith(date) )			//年月日必须与date�?��
		...
		//计算�?��时间�?		int i = 0, n = timepoint.length;
	...
	{
		long t = ( day.getTime() / 1000L );						//用时间的偏移量作为输出时�?		return new Text ( this.position + "|" + String.valueOf(t) );
	}
}